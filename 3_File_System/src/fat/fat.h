...
#define FAT_INVALID_MBR             1
#define FAT_NO_FAT_32_FOUND         2
#define FAT_INVALID_VBR             3


//It is possible to use longer names in FAT, but
//it is more complex, so nope... for now, at least.
...
typedef struct FATDirectory{                //For reference, you may use it as is (i.e. write your solution here)
                                            //or ignore it
...
void fat_read_file( uint8_t* fname, uint8_t* buffer, uint32_t bytes_to_read  );
